...
class _MessageState extends State<Message> with WidgetsBindingObserver {
  ...
  void sendMessage() async {
    ...
    await _chatService.sendMessage(
      ...
      replyToId: replyingTo?["messageId"], // MUST be messageId
  ...
  handleSwipeReply(
    ...
    // 🔥 FORCE FOCUS IMMEDIATELY (NO DELAY)
    FocusScope.of(context).requestFocus(_textFocusNode);

    // 🔥 ENSURE KEYBOARD OPENS IMMEDIATELY
    ...
    // optional scroll (kept minimal, no delay chain)
